...
<div class="grid_10 push_1">
        <div class="credit_option">
                <div class="pay_select">
                                ...
                                <ul>
                                        <li>
                                                <input onclick="changeMethodPayment('1');" type="radio" name="payment_method" id="payment_transfer" value="Transfer"/>
                                                <label for="payment_transfer">ชำระโดยโอนเงินผ่านบัญชีธนาคาร</label>
                                        </li>
                                        <li>
                                                <input onclick="changeMethodPayment('2');" type="radio" name="payment_method" id="payment_credit" value="Credit Card"/>
                                        ...
                                        <li>
                                                <input onclick="changeMethodPayment('4');" type="radio" name="payment_method" id="payment_counter_service" value="counter_service"/>
                                                <label for="payment_counter_service">ชำระผ่านเคาน์เตอร์เซอร์วิส</label>
                                        </li>
                                        <li>
                                                <input onclick="changeMethodPayment('5');" type="radio" name="payment_method" id="payment_coupon" value="coupon"/>
                                                <label for="payment_coupon">ใช้คูปองสมนาคุณเติมเครดิต</label>
                                        </li>
                                </ul>
