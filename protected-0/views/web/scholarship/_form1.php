...
<!--        <p>
	...
	<p>
        ...
        <?php echo  $form->hiddenField($model,'message',array('type'=>"hidden",'size'=>2,'maxlength'=>2,'value'=>'--')); ?>
        <?php echo  $form->hiddenField($model,'portfolio',array('type'=>"hidden",'size'=>2,'maxlength'=>2,'value'=>'--')); ?>
        ...
        <?php echo $form->checkBox($model,'scholarship_type'); ?>
