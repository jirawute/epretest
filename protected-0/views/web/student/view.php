...
<script type="text/javascript">
	...
	$(function(){
        ...
        function showExam(subject_id,type,subject_name,level){
            alert(subject_id);
            var type_name;
            $.ajax({
                url: '?r=exam/select&subject_id='+subject_id+'&level_id='+level,
                type: 'GET',
                dataType: 'html',
        ...
        function CheckStatusTest(status,exam_id){
        //alert(status);
            if(status==2){
            ...
            }else{OpenLink('index.php?r=exam&id='+exam_id);
            }

        }
        
        $(document).ready(function(){
alert(<? echo $level."XXXXX";?>);
})
        ...
        <div class="grid_5">
                <div class="profile_box" id="printable">
                        <div class="pic">
                                ...
                                <?php }?>
                                <p id="dontprint"><a href="#" onClick="window.print();">พิมพ์บัตร</a> | <a href="index.php?r=student/update">แก้ไขข้อมูล</a></p>
                        </div>
                        <div class="text">
...
<div class="grid_12 title_bar">
        ...
        <h2>เลือกชุดทดสอบสำหรับ <?php echo $level_info->name;?> เข้าคลังข้อสอบส่วนตัว</h2>
...
<a style="margin-left:10px;" class="view_all" 
   href="<?php echo Yii::app()->createUrl('student/view', array('level'=>$level->level_id)); ?>"><?php echo $level->name;?></a>
<?php }?>
</div>
    </div>
<div class="clear"></div>
