...
class ExamController extends Controller {
    ...
    public function actionIndex() {
        ...
        if (Yii::app()->user->id) {
            if (isset($_GET['id'])) {
                ...
                list($other1,$exam_id, $other2) = explode('$', $temp_id);
            } else {
            ...
            if ($session_detail['text_file'] != "") {
                $pText = $session_detail['text_file'];
                $pText = trim($pText);
    ...
    public function CountAns() {// Count selected answer when call this function
        $count_selected_ans = $count_selected_ans + 1;
        return $count_selected_ans;
    }
...
//                exit;
    ...
    // actionSubmit edited (include count answer)
...
//                exit;
          ...
          //  $_POST['ExamForm']['date_attended'] = date('Y-m-d H:i:s');
            ...
            $session_group1 = $session->getSessionByExamId1($id);
            $session_total = $session_group1['session_total'];

            $test = new Testing;
            //$count_selected = $test->getCountTestingRecordByID($test_record_id);

            
//Top edit "count selected choice"
//            if ($count_selected < $session_total) {
//                $this->redirect(Yii::app()->createUrl('exam/index', array('id' => $id, 'count_selected' => $count_selected, 'session_total' => $session_total)));
//            } else {
...
//                exit;
           ...
           // $_POST['ExamForm']['elapse_time'] = $model->elapse_time;
            ...
            $this->redirect(Yii::app()->createUrl('exam/index', array('id' => $id, 'count_selected' => $count_selected, 'student_id' => $student_id)));
        }
    }
