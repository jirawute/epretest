	...
	public function rules()
	{
		...
		return array(
			array('scholar_id, title_th, title_en, name_th, surename_th, name_en, surename_en, nickname_th, nickname_en, id_card, 
                            ...
                            image,how_to_know, profile,  scholarship_type', 'required','message'=>'กรุณากรอก {attribute}'),//,portfolio,reason, message,
			...
			array('school, major, email, parent_name, disease, language, language_other, travel_abroad_detail, image, portfolio, how_to_know_other', 'length', 'max'=>255),
