...
return array(
    ...
    'preload' => array('log'),
    //uncomment this line during maintaining system
//'catchAllRequest' => die('<div style="text-align:center;line-height:300px;font-size:100px;>Under Construction - ปิดปรับปรุงระบบ! ขออภัยในความไม่สะดวก</div>'),
