...
--
-- Host: localhost
-- Generation Time: Mar 01, 2013 at 03:40 AM
...
--
-- Table structure for table `esto_class_level`
--

CREATE TABLE IF NOT EXISTS `esto_class_level` (
...
--
-- Dumping data for table `esto_class_level`
--

INSERT INTO `esto_class_level` (`class_id`, `class_name`) VALUES
...
(9, 'ชั้นมัธยมศึกษาปีที่ 3'),
(10, 'ชั้นมัธยมศึกษาปีที่ 4'),
(11, 'ชั้นมัธยมศึกษาปีที่ 5'),
(12, 'ชั้นมัธยมศึกษาปีที่ 6');
...
INSERT INTO `esto_student` (`student_id`, `id_number`, `firstname`, `lastname`, `school`, `level_id`, `class_id`, `email`, `address`, `birthday`, `subject`, `faculty`, `phone`, `image`, `credit`, `username`, `password`) VALUES
(1, '1709800029160', 'Kanokwan', 'Phunmi', 'AAA School', 11, 12, 'kanokwan@khroton.com', '25/1 รามคำแหง 24 สวนหลวง กรุงเทพ', '1985-09-06', 'คณิตศาสตร์', 'วิทยาศาสตร์', '02-0123456', NULL, 200, 'kanokwan', '1234'),
(2, NULL, 'aaa', 'bbb', NULL, 12, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'ccc', 'ccc'),
(3, NULL, 'sss', 'sss', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'sss', 'sss');
...
CREATE TABLE IF NOT EXISTS `esto_type` (
  ...
  `name` varchar(128) COLLATE utf8_bin NOT NULL,
  `exam_type` enum('Exam','Exercise') COLLATE utf8_bin NOT NULL DEFAULT 'Exam',
  `sort_order` int(3) NOT NULL DEFAULT '0',
  `status` tinyint(1) NOT NULL,
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=4 ;
...
INSERT INTO `esto_type` (`type_id`, `name`, `exam_type`, `sort_order`, `status`) VALUES
(1, 'O-Net', 'Exam', 0, 1),
(2, 'GAT', 'Exam', 0, 1),
(3, 'PAT', 'Exam', 0, 1);
