...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'scholarship_type'); ?>
                ...
                <label style="float:left" for="Scholarship_scholarship_type_1">สมัครทุนการศึกษาเต็มจำนวนเท่านั้น</label>
                 <div class="clear"></div>
                ...
                <label for="Scholarship_scholarship_type_2">สมัครทั้งทุนการศึกษาเต็มจำนวนและทุนสมทบ  (หากได้รับคัดเลือกทุนสมทบ ผู้สมัครจะต้องจ่ายเงินสมทบเป็นเงิน  24,500  บาท)</label>
                </div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'status'); ?>
                <?php echo $form->dropDownList($model, 'status', array('0'=>'ไม่ผาน','1'=>'ได้รับสิทธิ์สอบสัมภาษณ์','2'=>'ผ่าน')); ?>
