...
//                            echo $test_rank;
            ...
            <div id="header" class="grid_12 do_exercise">
                ...
                <div class="point_detail">
                    <div class="box">คะแนนเฉลี่ย : <?php
                        if (isset($test_static['score_avg'])) {
                            echo number_format($test_static['score_avg']);
                        }
                        ?></div>
                    <div class="box">คะแนนสูงสุด : <?php
                        if (isset($test_static['score_max'])) {
