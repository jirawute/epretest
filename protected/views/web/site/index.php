...
<div class="grid_4 col1 list_subject">
    <?php echo CHtml::image(Yii::app()->baseUrl . '/images/web/testimonial/1.png', "title", array('width' => 300, 'height' => 445)); ?>
...
<div class="grid12 box_3step"><a href="<?php echo Yii::app()->createUrl('student/view'); ?>">
        <div class="box_3step_block one">
            ...
            <div class="pic_black two_b"></div></a>
    <h4>สมัคร</h4>
</div></a>
<div class="arrow a_1"></div><a  href="<?php echo Yii::app()->createUrl('site/page', array('view' => 'help')); ?>">
    <div class="box_3step_block two">
        <div class="number num2"></div>
        <div class="pic_orange one_o"></div>
        <div class="pic_black one_b"></div>
        <h4>เติม</h4>
    </div></a>
<div class="arrow a_2"></div><a href="<?php echo Yii::app()->createUrl('student/view'); ?>">
...
<div class="box_3step_description one">
    <p class="oneline_description">สมัครเป็นสมาชิกและลองทำข้อสอบฟรีวันนี้</p>
</div>
<div class="box_3step_description two">
    <p class="oneline_description">เติมเงินเพื่อทำข้อสอบที่หลากหลายมากขึ้น</p>

</div>
<div class="box_3step_description three">
    <p class="oneline_description">ลองทำข้อสอบและทบทวนเฉลย</p>
