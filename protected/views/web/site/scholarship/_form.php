...
<!--        <p>
	...
	<p>
        ...
        <p>
                <label style="width:250px;" >ท่านประสงค์จะสมัครขอรับทุนประเภทใด <span class="required">*</span></label>
                <div class="clear"></div>
                <div class="type">
                <input id="Scholarship_scholarship_type_1" type="radio" name="Scholarship[scholarship_type]" <?php if($model->scholarship_type==1){?>checked="checked"<?php } ?> value="1"/>
                <label for="Scholarship_scholarship_type_1">ขอรับทุนเฉพาะประเภทที่ 1 เท่านั้น (ประเภทที่ 1 ชำระเพิ่ม 33,500 บาท) </label>
                 <div class="clear"></div>
                <input id="Scholarship_scholarship_type_2" type="radio" name="Scholarship[scholarship_type]" <?php if($model->scholarship_type==2){?>checked="checked"<?php } ?> value="2"/>
                <label for="Scholarship_scholarship_type_2">ขอรับทุนเฉพาะประเภทที่ 1 และ 2 เท่านั้น (ประเภทที่ 2 ชำระเพิ่ม 43,500 บาท)</label>
                <div class="clear"></div>
                <input id="Scholarship_scholarship_type_3" type="radio" name="Scholarship[scholarship_type]" <?php if($model->scholarship_type==3){?>checked="checked"<?php } ?> value="2"/>
                <label for="Scholarship_scholarship_type_3">ขอรับทุนประเภทที่ 1 ประเภทที่ 2 และประเภทที่ 3 (ประเภทที่ 3 ชำระเพ่ิม 53,500 บาท)</label>
                <div class="clear"></div>
                <input id="Scholarship_scholarship_type_4" type="radio" name="Scholarship[scholarship_type]" <?php if($model->scholarship_type==4){?>checked="checked"<?php } ?> value="2"/>
                <label for="Scholarship_scholarship_type_4">ต้องการสมัครแบบไม่ขอรับทุนการศึกษา (เดินทางแน่นอน - ชำระ 73,500 บาท)</label>
                <div class="clear"></div>
                </div>
                <div class="clear"></div>
