        ...
        <?php endif; ?>
                <div class="editinfo_box">
                        ...
                        <h2>แบบฟอร์มแจ้งการโอนเงิน</h2>
                                <h3  class="orange">
                                 ข้อมูลสำหรับการโอนเงิน<br/>
                                 บัญชีกระแสรายวัน ธนาคารกสิกรไทย สาขา สยามสแควร์<br/>
                                 ชื่อบัญชี บริษัท เอ็ดดูเคชั่น สตูดิโอ จำกัด 
                                 เลขที่บัญชี 026-1-10869-0</h3>
                        ...
                        <div class="editinfo_data_box">
                               <?php $form=$this->beginWidget('CActiveForm', array(
                                        ...
                                        <p>
                                            ...
                                            <?php echo $form->textField($model,'inv_id',array('size'=>10,'maxlength'=>6,'value'=>$scholar_enroll->inv_id,'readonly'=>'readonly')); ?>
                                        ...
                                        <p>
                                             ...
                                             <?php echo $form->textField($model,'email',array('size'=>60,'maxlength'=>255,'value'=>$scholar_enroll->email,'readonly'=>'readonly')); ?>
                                        ...
                                        <p>
                                             ...
                                             <?php echo $form->textField($model, 'bank',array('size'=>40)); ?>
